// Package frameworks is the Go SDK for the FrameWorks GraphQL API.
//
...
//
// The TypeScript, Go, and Python SDKs share one version and one operation
// set; MinServerVersion is the oldest FrameWorks release this SDK line
// supports.
package frameworks
